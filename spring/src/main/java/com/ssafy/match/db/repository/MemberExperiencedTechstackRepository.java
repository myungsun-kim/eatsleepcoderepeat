...
public interface MemberExperiencedTechstackRepository extends
    ...
    @Query(value = "select mt.compositeMemberTechstack.techstack from matching.member_experienced_techstack mt where mt.compositeMemberTechstack.member = :member")
