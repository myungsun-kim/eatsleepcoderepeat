...
@Data
public class ProjectArticleListDto {
    ...
    public static ProjectArticleListDto of(ProjectArticle projectArticle) {
        return ProjectArticleListDto.builder()
    ...
    @Builder
    public ProjectArticleListDto(Long articleId, String title, String projectBoard, String createdMember, LocalDateTime createdDate, LocalDateTime modifiedDate, Integer viewCount) {
