...
public class ProjectArticleCommentController {
    ...
    public ResponseEntity<Long> create(@PathVariable("articleId") Long articleId,
        ...
        throws Exception {
        return ResponseEntity.ok(projectCommentService.create(articleId, parentId, dto));
    }
    ...
    public ResponseEntity<List<ProjectArticleCommentResponseDto>> getAllComment(@PathVariable("articleId") Long articleId) {
        return ResponseEntity.ok(projectCommentService.allComment(articleId));
    }
    ...
    public ResponseEntity<HttpStatus> update(@PathVariable("commentId") Long commentId,
        @RequestBody ProjectArticleCommentRequestDto dto) throws Exception {
        return ResponseEntity.ok(projectCommentService.update(commentId, dto));
    }
    ...
    public ResponseEntity<HttpStatus> delete(@PathVariable("commentId") Long commentId)
        throws Exception {
        return ResponseEntity.ok(projectCommentService.delete(commentId));
    }
