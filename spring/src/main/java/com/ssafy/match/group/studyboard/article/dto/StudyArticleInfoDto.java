...
@Data
public class StudyArticleInfoDto {
    ...
    public static StudyArticleInfoDto of(StudyArticle studyArticle) {
        return StudyArticleInfoDto.builder()
    ...
    @Builder
    public StudyArticleInfoDto(Long articleId, String title, String studyBoard, String createdMember, LocalDateTime createdDate, LocalDateTime modifiedDate, Integer viewCount) {
