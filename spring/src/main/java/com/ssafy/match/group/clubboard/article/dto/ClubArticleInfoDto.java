...
@Data
public class ClubArticleInfoDto {
    ...
    public static ClubArticleInfoDto of(ClubArticle clubArticle) {
        return ClubArticleInfoDto.builder()
    ...
    @Builder
    public ClubArticleInfoDto(Long articleId, String title, String clubBoard, String createdMember, LocalDateTime createdDate, LocalDateTime modifiedDate, Integer viewCount) {
