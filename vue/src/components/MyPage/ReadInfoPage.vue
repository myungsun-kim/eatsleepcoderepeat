<template>
  ...
  <el-row class="height90">
    ...
    <el-col :span="8" :offset="1" class="test-border font-14 flex-parent">
      ...
      <el-row class="test-border"> </el-row>
    </el-col>

    <!-- 우측 -->
    <el-col :span="12" :offset="1" class="test-border">
      <el-row class="test-border title"
        >{{ user.nickname }}님이 속한 클럽</el-row
      >
      <!-- <el-row class="height5"></el-row> -->
      <!-- 아이템 목록 시작 -->
      ...
      <!-- <el-row class="height5"></el-row> -->
      <el-row class="test-border title"
        >{{ user.nickname }}님이 속한 스터디</el-row
      >
      <!-- <el-row class="height5"></el-row> -->
      <!-- 아이템 목록 시작 -->
      ...
      <!-- 아이템 목록 끝 -->
      <!-- <el-row class="height5"></el-row> -->
      <el-row class="height5 test-border title"
        >{{ user.nickname }}님이 속한 프로젝트</el-row
      >
      <!-- <el-row class="height5"></el-row> -->
      <!-- 아이템 목록 시작 -->
      ...
      <!-- 아이템 목록 끝 -->
      <el-row><el-col :span="22"></el-col> <el-col :span="2"></el-col></el-row>
    </el-col>
  </el-row>
</template>
