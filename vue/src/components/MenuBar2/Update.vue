<template>
  <el-row class="height5">
    <el-col :span="24" class="test-border">
      UPDATE - study, project, club 5% 여백. 입력 줄 간 간격을 넣을 것인지
      말것인지 결정해야함
    </el-col>
  </el-row>
  ...
  <el-row class="test-border">
    ...
    <el-col :span="14" class="test-border">
      ...
      <el-row class="test-border height5">기술 스택</el-row>
      <el-row class="test-border height5">
        <el-input
          placeholder="사용하는 기술 스택을 입력해주세요"
          v-model="temp"
          size="mini"
        ></el-input>
      </el-row>
      <el-row class="test-border">
        <el-col :span="11" class="test-border">
          ...
          <el-row>
            <el-input
              placeholder="스터디 일정을 입력해주세요"
              v-model="temp"
              size="mini"
            ></el-input>
          </el-row>
          <el-row> 스터디 기간(단위: 주) </el-row>
          <el-row>
            <el-input
      ...
      <el-row class="test-border height5">지역</el-row>
      <el-row class="test-border height5">
        <el-input
      ...
      <el-row class="test-border height5"></el-row>
      <el-row class="test-border height5">소속 클럽</el-row>
      <el-row class="test-border height5">
        <el-input
          placeholder="소속된 클럽을 선택하세요"
          v-model="temp"
          size="mini"
        ></el-input>
      </el-row>
      ...
      <el-row class="test-border height5"></el-row>
      <el-row class="test-border height5">스터디 상태</el-row>
      <el-row class="test-border height5"> ✔ 진행중 모집중 종료됨 </el-row>

      <el-row class="test-border height5"></el-row>
      <el-row class="test-border height5">진행 중</el-row>
      <el-row class="test-border height5"> ✔ 참여 가능 참여 불가 </el-row>

      <el-row class="test-border height5"></el-row>
      <el-row class="test-border height5">소개</el-row>
      <el-row class="test-border height5">
        <el-input
